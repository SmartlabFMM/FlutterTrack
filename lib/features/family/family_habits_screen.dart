...
class FamilyHabitsScreen extends ConsumerStatefulWidget {
  const FamilyHabitsScreen({super.key});
  @override
  ConsumerState<FamilyHabitsScreen> createState() => _FamilyHabitsScreenState();
}

class _FamilyHabitsScreenState extends ConsumerState<FamilyHabitsScreen> {
  bool _saving = false;
  ...
  Future<void> _save() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        ...
        backgroundColor: ok ? AppColors.tealDark : AppColors.danger,
      ));
      if (ok) context.pop();
    }
  }
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    const Expanded(
                      child: Text(
                        'Remplissez les habitudes du patient pour aujourd\'hui.',
                        style: TextStyle(
                ...
                _NumericCard(
                  ...
                  title:     'Hydratation',
                  subtitle:  "Verres d'eau bus aujourd'hui",
