...
class _VitalsSummaryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      ...
      _MiniStat(label: 'Accél.', value: accel.toStringAsFixed(2),
        unit: 'g', color: AppColors.accelColor, alert: accelAlert),
      const SizedBox(width: 8),
    ...
    child: Row(children: [
      ...
      const Expanded(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Bracelet non connecté',
              style: TextStyle(
                fontSize: 13, fontWeight: FontWeight.w700,
                color: AppColors.textPrimary)),
            SizedBox(height: 2),
            Text('Les signaux s\'affichent dès que le patient\nporte son bracelet.',
              style: TextStyle(
